package com.github.ravenzip.berezaUI.components.button
...
import com.github.ravenzip.berezaUI.style.IconStyle
...
fun IconButton(
    ...
    _root_ide_package_.com.github.ravenzip.berezaUI.components.layout.RoundedBox(
        modifier =
            Modifier.clickable(
                    onClick = onClick,
                    enabled = isEnabled,
